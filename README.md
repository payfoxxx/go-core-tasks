...
3. [Запуск проекта и тестов](#запуск-проекта-и-тестов)

4. [Список задач](#описание-задач)

---

### Описание проекта

Проект представляет собой решение задач на языке Golang. Всего 9 задач направленных на работу с стандартной библиотекой Golang
...
```bash
git clone https://github.com/payfoxxx/go-core-tasks.git
```
...
4. Запустить тесты конкретной задачи
...
1. [Задача 2](#задание-2)
1. [Задача 3](#задание-3)
1. [Задача 4](#задание-4)
1. [Задача 5](#задание-5)
1. [Задача 6](#задание-6)
1. [Задача 7](#задание-7)
1. [Задача 8](#задание-8)
1. [Задача 9](#задание-9)
